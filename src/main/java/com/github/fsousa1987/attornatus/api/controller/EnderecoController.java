...
//    public ResponseEntity<EnderecoResponse> adicionarEndereco(@PathVariable Long idPessoa, @RequestBody @Valid AdicionarEnderecoRequest request) {
...
//    public ResponseEntity<EnderecoResponse> atualizar(@PathVariable Long idEndereco, @RequestBody @Valid EnderecoRequest request) {
