...
public class EnderecoController {
    ...
    public ResponseEntity<EnderecoResponse> adicionarEndereco(@PathVariable Long idPessoa,
                                                              @RequestBody @Valid AdicionarEnderecoRequest request) {
        EnderecoResponse enderecoResponse = enderecoService.adicionarEndereco(idPessoa, request);
    ...
    public ResponseEntity<EnderecoLoteResponse> adicionarEnderecosEmLote(@PathVariable Long idPessoa,
                                                                         @RequestBody @Valid AdicionarEnderecosLoteRequest request) {
        EnderecoLoteResponse enderecoLoteResponse =
                enderecoService.adicionarEnderecosEmLote(idPessoa, request.getEnderecos());
    ...
    public ResponseEntity<EnderecoResponse> atualizar(@PathVariable Long idEndereco,
